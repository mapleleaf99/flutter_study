...
class KnowledgetData {
  List<KnowledgeListData?>? list = [];

  KnowledgetData.fromJson(dynamic json) {
    if (json is List) {
...
class KnowledgeListData {
  ...
  KnowledgeListData.fromJson(dynamic json) {
    ...
    if (json['children'] != null) {
      ...
      json['children'].forEach((v) {
        children?.add(KnowlegeChildren.fromJson(v));
      });
    }
  ...
  String? author;
  List<KnowlegeChildren>? children;
  num? courseId;
  String? cover;
  String? desc;
  num? id;
...
class KnowlegeChildren {
  ...
  KnowlegeChildren.fromJson(dynamic json) {
    if (json['articleList'] != null) {
      articleList = [];
      json['articleList'].forEach((v) {
        articleList?.add(v);
